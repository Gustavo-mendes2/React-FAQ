...
var Du = Array.isArray,
  ...
  Ai = { current: null },
  Zo = { key: !0, ref: !0, __self: !0, __source: !0 };
function Jo(e, n, t) {
  var r,
    l = {},
    i = null,
  ...
  if (n != null)
    ...
    n))
      Go.call(n, r) && !Zo.hasOwnProperty(r) && (l[r] = n[r]);
...
function yr(e, n, t, r, l) {
  ...
  if (((u = 0), (r = r === "" ? "." : r + ":"), Du(e)))
    ...
    for (e = s.call(e), o = 0; !(i = e.next()).done; )
      (i = i.value), (s = r + wl(i, o++)), (u += yr(i, n, t, s, l));
  else if (i === "object")
    throw (
      ((n = String(e)),
      Error(
...
L.cloneElement = function (e, n, t) {
  ...
  if (n != null) {
    if (
      (n.ref !== void 0 && ((i = n.ref), (u = Ai.current)),
...
function qi(e, n, t, r) {
  if (Dr) {
    ...
    else if ((Ku(e, r), n & 4 && -1 < qc.indexOf(e))) {
      for (; l !== null; ) {
        var i = Zt(l);
        if (
          (i !== null && zs(i),
  ...
  tl = A({}, Gt, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== pt &&
            (pt && e.type === "mousemove"
              ? ((xl = e.screenX - pt.screenX), (Nl = e.screenY - pt.screenY))
              : (Nl = xl = 0),
            (pt = e)),
          xl);
    },
...
var yf = A({}, Gt, {
  ...
  kf = we(Sf),
  Ef = A({}, it, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Cf = we(Ef),
  _f = A({}, tl, {
    deltaX: function (e) {
...
var Pf = He && "TextEvent" in window && !Ct,
  Is = He && (!tu || (Ct && 8 < Ct && 11 >= Ct)),
  qu = " ",
  bu = !1;
function Fs(e, n) {
  switch (e) {
...
function Lf(e, n) {
  if (In)
    return e === "compositionend" || (!tu && Fs(e, n))
      ? ((e = Ds()), (Sr = bi = en = null), (In = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function Mf(e, n, t) {
  e === "focusin"
    ? (to(), (_t = n), (Ft = t), _t.attachEvent("onpropertychange", As))
    : e === "focusout" && to();
}
function Df(e) {
...
function so(e, n, t, r, l) {
  for (var i = n._reactName, u = []; t !== null && t !== r; ) {
    ...
    o.tag === 5 &&
      ...
      ((o = c),
      l
        ? ((s = Ot(t, i)), s != null && u.unshift($t(t, s, o)))
        : l || ((s = Ot(t, i)), s != null && u.push($t(t, s, o)))),
      (t = t.return);
  }
...
var hi = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Kf =
    typeof queueMicrotask == "function"
      ...
      : typeof co < "u"
      ? function (e) {
          return co.resolve(null).then(e).catch(Yf);
        }
      : hi;
function Yf(e) {
  setTimeout(function () {
...
function bs(e, n, t) {
  (Se[ke++] = Ve), (Se[ke++] = Qe), (Se[ke++] = Nn), (Nn = e);
  var r = Ve;
  e = Qe;
  var l = 32 - Re(r) - 1;
  (r &= ~(1 << l)), (t += 1);
  ...
  switch (e.tag) {
    ...
    case 13:
      return (
        ...
        n !== null
          ? ((t = Nn !== null ? { id: Ve, overflow: Qe } : null),
            (e.memoizedState = {
              dehydrated: n,
              treeContext: t,
...
function _e(e) {
  ...
  if (ou !== e)
    if (((e = { context: e, memoizedValue: n, next: null }), Qn === null)) {
      ...
      (Qn = e), (Br.dependencies = { lanes: 0, firstContext: e });
    } else Qn = Qn.next = e;
  return n;
}
var kn = null;
...
function Ci(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = la), fu(e);
  var i = n.contextType;
  typeof i == "object" && i !== null
    ? (l.context = _e(i))
    : ((i = de(n) ? xn : re.current), (l.context = qn(e, i))),
...
function ua(e) {
  ...
  function w(f, a, d, h) {
    for (
      var E = null, _ = null, x = a, N = (a = 0), Q = null;
      x !== null && N < d.length;
      N++
    ) {
    ...
    if (x === null) {
      for (; N < d.length; N++)
        (x = m(f, d[N], h)),
          x !== null &&
            ((a = i(x, a, N)), _ === null ? (E = x) : (_.sibling = x), (_ = x));
      return j && gn(f, N), E;
    }
    for (x = r(f, x); N < d.length; N++)
      (Q = g(x, f, N, d[N], h)),
        Q !== null &&
          (e && Q.alternate !== null && x.delete(Q.key === null ? N : Q.key),
          (a = i(Q, a, N)),
  ...
  function S(f, a, d, h) {
    ...
    for (
      var _ = (E = null), x = a, N = (a = 0), Q = null, T = d.next();
      x !== null && !T.done;
      N++, T = d.next()
    ) {
      x.index > N ? ((Q = x), (x = null)) : (Q = x.sibling);
...
function du(e, n) {
  switch ((M(Qt, n), M(Vt, e), M(Ue, Jt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
var ud = Xe.ReactCurrentOwner,
  ce = !1;
function le(e, n, t, r) {
  n.child = e === null ? oa(n, null, t, r) : et(n, e.child, t, r);
}
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (j && t && lu(n), (n.flags |= 1), le(e, n, r, l), n.child)
  );
}
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (j && r && lu(n), (n.flags |= 1), le(e, n, t, l), n.child)
  );
}
function Lo(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    xr(e, n), ia(n, t, r), Ci(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      o = n.memoizedProps;
    u.props = o;
    ...
    (u = n.stateNode),
      ra(e, n),
      (o = n.memoizedProps),
      (c = n.type === n.elementType ? o : ze(n.type, o)),
      (u.props = c),
      (m = n.pendingProps),
      (p = u.context),
      (s = t.contextType),
...
function Ni(e, n, t, r, l, i) {
  ...
  return (
    (n.flags |= 1),
    e !== null && u
      ? ((n.child = et(n, e.child, null, i)), (n.child = et(n, null, o, i)))
      : le(e, n, o, i),
...
function To(e, n, t, r, l) {
  return bn(), uu(l), (n.flags |= 256), le(e, n, t, r), n.child;
}
...
function Da(e, n, t) {
  ...
  if (i) {
    ...
    return (
      ...
      o !== null ? (i = cn(o, i)) : ((i = _n(i, u, t, null)), (i.flags |= 2)),
      (i.return = n),
      (r.return = n),
      (r.sibling = i),
      (n.child = r),
...
function od(e, n, t, r, l, i, u) {
  ...
  if (l.data === "$!") {
    ...
    return (r = o), (i = Error(y(419))), (r = Vl(i, r, void 0)), pr(e, n, u, r);
  }
  ...
  switch ((iu(n), n.tag)) {
        ...
        (e === null || e.child === null) &&
          (fr(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), Te !== null && (ji(Te), (Te = null)))),
        Li(e, n),
        ne(n),
        null
      );
    ...
    case 6:
      if (e && n.stateNode != null) Ua(e, n, e.memoizedProps, r);
        ...
        if (((t = En(Qt.current)), En(Ue.current), fr(n))) {
          if (
            ((r = n.stateNode),
            (t = n.memoizedProps),
            (r[Fe] = n),
    ...
    case 13:
      if (
        ...
        if (j && ve !== null && n.mode & 1 && !(n.flags & 128))
          ...
          ne(n), (i = !1);
        } else Te !== null && (ji(Te), (Te = null)), (i = !0);
    ...
    case 4:
      return (
        nt(), Li(e, n), e === null && Ut(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[At], delete n[yi], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
        ...
        e: for (; o !== null; ) {
          switch (o.tag) {
            case 5:
              ...
              break e;
            case 3:
              (J = o.stateNode.containerInfo), (Le = !0);
              break e;
            case 4:
              (J = o.stateNode.containerInfo), (Le = !0);
              break e;
    ...
    case 5:
      ...
      if (r & 4 && ((l = e.stateNode), l != null)) {
        ...
        if (((e.updateQueue = null), s !== null))
          try {
            o === "input" && i.type === "radio" && i.name != null && as(l, i),
              ri(o, u);
            var c = ri(o, i);
...
function Ba(e, n, t) {
  for (var r = (e.mode & 1) !== 0; k !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && i !== null ? ((i.return = l), (k = i)) : Io(e);
  }
}
function Io(e) {
  for (; k !== null; ) {
...
function Oe(e, n, t, r) {
  if (50 < Lt) throw ((Lt = 0), (Ii = null), Error(y(185)));
  Xt(e, t, r),
    (!(R & 2) || e !== Z) &&
      (e === Z && (!(R & 2) && (cl |= t), Y === 4 && be(e, q)),
      pe(e, r),
      t === 1 && R === 0 && !(n.mode & 1) && ((rt = H() + 500), ul && vn()));
}
function pe(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Wu(t), n === 1))
      e.tag === 0 ? Zf(Uo.bind(null, e)) : qs(Uo.bind(null, e)),
        Kf(function () {
          !(R & 6) && vn();
        }),
        (t = null);
...
function Ha(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = Jr(e, r);
    ...
    su(),
      (Xr.current = i),
      (R = l),
      W !== null ? (n = 0) : ((Z = null), (q = 0), (n = Y));
  }
  if (n !== 0) {
    if (
      (n === 2 && ((l = si(e)), l !== 0 && ((r = l), (n = Fi(e, l)))), n === 1)
    )
      throw ((t = Kt), Cn(e, 0), be(e, r), pe(e, H()), t);
    if (n === 6) be(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (be(e, r), (r & 130023424) === r && ((n = Cu + 500 - H()), 10 < n))
          ) {
            if (Mr(e, 0) !== 0) break;
...
function Uo(e) {
  ...
  if (t === 1) throw ((t = Kt), Cn(e, 0), be(e, n), pe(e, H()), t);
...
function Cn(e, n) {
  ...
  if ((t !== -1 && ((e.timeoutHandle = -1), Wf(t)), W !== null))
...
function Jr(e, n) {
  ...
  while (!0);
  if ((su(), (R = t), (Xr.current = r), W !== null)) throw Error(y(261));
  return (Z = null), (q = 0), Y;
}
function hd() {
  for (; W !== null; ) Ya(W);
...
function wd(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    Z === e &&
      (q & t) === t &&
      (Y === 4 || (Y === 3 && (q & 130023424) === q && 500 > H() - Cu)
        ? Cn(e, 0)
        : (Eu |= t)),
    pe(e, n);
}
...
Za = function (e, n, t) {
  ...
  else (ce = !1), j && n.flags & 1048576 && bs(n, Vr, n.index);
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            Ci(n, r, e, t),
            (n = Ni(null, n, r, !0, i, t)))
          : ((n.tag = 0), j && i && lu(n), le(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
      ...
      e: {
        ...
        if (((r = u.element), i.isDehydrated))
          if (
            ...
            (l = tt(Error(y(423)), n)), (n = To(e, n, r, t, l));
            break e;
          } else if (r !== l) {
            (l = tt(Error(y(424)), n)), (n = To(e, n, r, t, l));
            break e;
          } else
            for (
...
function Pd(e, n, t, r, l) {
  ...
  var s = zu(e, 0, !1, null, null, !1, !1, "", Vo);
  return (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zi(n, t | 1), pe(n, H()), !(R & 6) && ((rt = H() + 500), vn()));
      }
      break;
    case 13:
      Ln(function () {
...
ys = _u;
gs = Ln;
var zd = { usingClientEntryPoint: !1, Events: [Zt, Un, il, vs, hs, _u] },
  ht = {
  ...
  Ld = {
    ...
    findFiberByHostInstance: ht.findFiberByHostInstance || Nd,
...
ge.hydrateRoot = function (e, n, t) {
  ...
  if (
    ...
    (n = ba(n, null, e, 1, t ?? null, l, !1, i, u)),
    (e[We] = n.current),
    Ut(e),
    r)
  )
...
var Td = bo.exports,
  Qo = Td;
(Wl.createRoot = Qo.createRoot), (Wl.hydrateRoot = Qo.hydrateRoot);
const Rd = ({ id: e, question: n }) => {
  const [t, r] = el.useState(!1);
  function l() {
    return t == !1 ? r(!0) : r(!1);
  }
  return ie.jsx(ie.Fragment, {
    children: ie.jsxs(
      "div",
      {
        className: "question",
        children: [
          ie.jsx("p", { className: "title", children: n.title }),
          ie.jsx("button", { onClick: l, children: t ? "-" : "+" }),
          t && ie.jsx("p", { className: "description", children: n.info }),
        ],
      },
      e
    ),
...
function Od() {
  return ie.jsxs(ie.Fragment, {
    children: [
      ie.jsx("h1", { children: "FAQ/Accordion" }),
      ie.jsxs("div", {
        className: "container",
        children: [
          ie.jsx("h2", { children: "Frequently Asked Questions" }),
          ie.jsx("div", {
            className: "questions",
            children: Md.map((e) => ie.jsx(Rd, { question: e }, e.id)),
          }),
        ],
      }),
    ],
...
Wl.createRoot(document.getElementById("root")).render(
  ie.jsx(wc.StrictMode, { children: ie.jsx(Od, {}) })
);
